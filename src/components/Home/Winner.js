...
const Winner = (props) => {
  ...
  return (
    <div className="absolute w-full ">
      <p className="absolute inset-x-0 top-0  text-3xl flex w-full mx-auto justify-center items-center">
        We are undefeated Winner
      </p>
      ...
      <div className="absolute inset-x-0 top-0 pt-16 h-auto mb-24 flex lg:flex-row flex-col w-full mx-auto   container">
        <div className="flex-1">
          <div className="relative mb-16">
            <div className="avatar flex flex-col absolute top-0 left-0">
              <div className="w-32 ml-6 flex mt-1 rounded-full">
                <img className="" src={certificate} />
              </div>
              <p>Certificate of completion on 2020</p>
            </div>
            <div className="avatar flex flex-col pl-64">
        ...
        <div className="flex-1 flex flex-col lg:flex-row text-left">
          <div className="flex flex-col">
            ...
            <p>
              Award always matters organization like us. We really deserve for
              this. Now it's time for us. Our journey will not end after this
            </p>
          </div>
